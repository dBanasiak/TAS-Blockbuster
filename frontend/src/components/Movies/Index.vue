       ...
       <UserPanel class="movie-items" title="Movies">
         <div v-for="movie in movies" class="movie-panel" :key="movie.title">
           <div class="movie-left-panel">
            ...
            <div class="movie-description"><strong>Description:</strong><div class="movie-block">{{movie.description}}</div></div>
            <div class="movie-cast">
            <strong>Director:</strong> {{movie.director}} <span> | </span>
          ...
          <div class="movie-right-panel">
            ...
            <h2 class="movie-title">{{movie.title}} <span class="movie-date">{{movie.date}}</span></h2>
          </div>
         </div>
       </UserPanel>
        <movies-search-panel/>
       <movies-panel class = "mt-2" />
    </v-flex>
  </v-layout>
</template>
